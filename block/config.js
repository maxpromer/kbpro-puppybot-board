    ...
    base_blocks : [ // use "blocks : [ " in normally situation but this need to override base block from esp-idf platforms
        {
            ...
            blocks : [
                ...
                { // TODO: puppybot.h dont have function for code can gen
                    xml : 
                ...
                {
                    xml : 
                    `<block type="puppybot_motor_stop_ch">
                        <value name="speed">
                            <shadow type="math_number">
                ...
                {
                    xml : 
                    `<block type="puppybot_motor_forward">
                        <value name="speed">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                {
                    xml : 
                    `<block type="puppybot_motor_backward">
                        <value name="speed">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                {
                    xml : 
                    `<block type="puppybot_motor_turn">
                        <value name="speed">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                {
                    xml : 
                    `<block type="puppybot_motor_spin">
                        <value name="speed">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                { 
                    xml : 
                    `<block type="puppybot_motor_forward2">
                        <value name="speed1">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                { 
                    xml : 
                    `<block type="puppybot_motor_backward2">
                        <value name="speed1">
                            <shadow type="math_number">
                                <field name="NUM">50</field>
                            </shadow>
                ...
                'Readline_PID', // TODO: puppybot.h dont have function for code can gen
                { 
                    xml : 
