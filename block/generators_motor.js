...
module.exports = function(Blockly) {
  ...
  Blockly.JavaScript['puppybot_motor'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
  var dropdown_dir = block.getFieldValue('dir');
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC);
  var code = 'motor(' + dropdown_ch + ', ' + (dropdown_dir === "1" ? "" : "-") + value_speed + ');\n';
  return code;
};
...
Blockly.JavaScript['puppybot_motor_forward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, ' + value_speed + ');\t';
  code += 'motor(2, ' + value_speed + ');delay(10);\n';
  return code;
};

Blockly.JavaScript['puppybot_motor_backward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, -' + value_speed + ');\t';
  code += 'motor(2, -' + value_speed + ');delay(10);\n';
...
Blockly.JavaScript['puppybot_motor_spin'] = function(block) {
...
Blockly.JavaScript['puppybot_motor_turn'] = function(block) {
  var dropdown_ch = block.getFieldValue('direction');
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || 0;
  var code = '';
  if(dropdown_ch == 1){
    ...
    code += 'motor(1, ' + value_speed + ');\t';
    code += 'motor(2, 0);delay(10);\n';
  }
  return code;
};
Blockly.JavaScript['puppybot_motor_turn_left'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, 0);\t';
  code += 'motor(2, ' + value_speed + ');delay(10);\n';
...
Blockly.JavaScript['puppybot_motor_turn_right'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, ' + value_speed + ');delay(10);\t';
  code += 'motor(2, 0);\n';
  return code;
};

Blockly.JavaScript['puppybot_motor_spin_left'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, -' + value_speed + ');\t';
  code += 'motor(2, ' + value_speed + ');delay(10);\n';
...
Blockly.JavaScript['puppybot_motor_spin_right'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, ' + value_speed + ');\t';
  code += 'motor(2, -' + value_speed + ');delay(10);\n';
...
Blockly.JavaScript['puppybot_motor_stop'] = function(block) {  
  var code = 'ao();delay(10);\n';
  return code;
};

Blockly.JavaScript['puppybot_motor_stop_ch'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
  var code = '';
  if(dropdown_ch == 0){
    code += 'motor(1, 0);\n';
...
Blockly.JavaScript['puppybot_motor_forward2'] = function(block) {
  ...
  code += 'motor(2, ' + value_speed2 + ');delay(10);\n';
  return code;
};

Blockly.JavaScript['puppybot_motor_backward2'] = function(block) {
  var value_speed1 = Blockly.JavaScript.valueToCode(block, 'speed1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed2 = Blockly.JavaScript.valueToCode(block, 'speed2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, -' + value_speed1 + ');\t';
...
Blockly.JavaScript['Run_following_of_line'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'lineFollow_PID( ' + value_speed + ');\n';
  return code;
};
